//Use the below to add the ammo types to the CBA compatable ammo types used in a majority of guns for compatability reasons.
//In future we may want to look at adding other GL alternatives.
